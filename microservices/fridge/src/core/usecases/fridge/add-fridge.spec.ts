...
import { addFridge } from ".."


describe("Testing adding fridge", () => {

    it("Test adding valid fridge", async() => {
        const id = uuid.v4();
        ...
        const ret = await addFridge(id, ingredients_names, capacities, units);
    ...
    it("Test adding fridge with id that already exist", async() => {
        const id = uuid.v4();
        const ingredients_names = new Array<string>(...["tomatos", "potats", "chocolate"]);
        const capacities = new Array<number>(...[0, 1, 2]);
        const units = new Array<string>(...["k.g", "k.g", "pieces"]);
        ...
        ret = await addFridge(id, ingredients_names, capacities, units);        
        expect(ret).toBeUndefined()
    });

    it("Test adding invalid fridge capacities", async() => {
        const id = uuid.v4();
        const ingredients_names = new Array<string>(...["tomatos", "potats", "chocolate"]);
    ...
    it("Test adding invalid fridge units", async() => {
        const id = uuid.v4();
        const ingredients_names = new Array<string>(...["tomatos", "potats", "chocolate"]);
        const capacities = new Array<number>(...[0, 1, 2]);
    ...
    it("Test adding invalid fridge ingredient names", async() => {
        const id = uuid.v4();
